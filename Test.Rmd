...
Die Pandoc / Markdown Notation für Definitions wird unterstützt:

    Term 1:
    :   Definition 1
%>% 
Dabei wird der Term in FHDOrange gesetzt. 
...
## Übung `r nextExercise()`: Ein Slide mit einer Übung {.exercise}
...
- Links lassen sich in der `R markdown` Notation einfügen:

  `[Linktext](URL)` &rarr; [FH Dortmund](https://www.fh-dortmund.de)

- Die farbliche Hervorhebung und Unterstreichung exerner Links muss noch überarbeitet werden, um diese besser vom restlichen Folientext abzuheben. Gedacht ist an eine Unterstreichung in FHDOrange bei grauem Text.
