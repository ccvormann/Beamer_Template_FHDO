...
bibliography: "/home/ccv/Google Drive/Wiss_Arbeiten/Meine Bibliothek.bib"
...
- Das Template unterstützt eine Gliederung in Abschnite `#` und Folien `##`
...
2. sind ebenfalls vorgesehen^[hier sollte die Formatierung noch angepasst werden]
...
- Fußnoten werden in der Präsentation fortlaufend numeriert^[vgl. @Kahneman2021]. In der Template-Datei kann die Nutzung des Fußnotenzeichens abgestellt werden, wenn in den Fußnoten eher die Quellen der Seite angegeben werden sollen
  - Die Abschaltung erfolgt dokumentenweit
